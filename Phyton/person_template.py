...
class Person:
    ...
    def __init__(self, name, initial_money, first_address):
        """
        ...
        :param first_address: str, the address of the person
            that he lives on at the point of creation.
        """

        self.__name = name
        self.__money = initial_money
        self.__address = first_address
    ...
    def move(self, address):
        """
        When moving to another address, persons details
        need to be updated in system.

        :param address: str, New address to which the
                            person is moving to.
        """
