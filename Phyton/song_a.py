# This program prints the words of the song Puff the Magic Dragon.

def print_chorus():
    """This function prints text that is repeating through the song"""
...
def main():
    """This function is printing lyrics of the song."""
    print("Puff, the magic dragon lived by the sea")
    print("And frolicked in the autumn mist in a land called Honah Lee,")
