...
def calculate_average(some_dict):
    """
    Calculates average of all values in dictionary.

    :param some_dict: dict, Dictionary from which average value is calculčated.
